...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //获取公私钥,1024位（其他位数可能会出现问题）
        Map<String, String> keysMap = createKeys(1024);
        //经过Base64编码获取最终公钥，私钥
        RSAPrivateKey privateKey = getPrivateKey(keysMap.get("privateKey"));
        RSAPublicKey publicKey = getPublicKey(keysMap.get("publicKey"));

        //公钥加密，私钥解密
        String publicEncrypt = publicEncrypt(data, publicKey);
        System.out.println("publicEncrypt = " + publicEncrypt);

        String str = privateDecrypt(publicEncrypt, privateKey);
        System.out.println("originData = " + str);
    }
