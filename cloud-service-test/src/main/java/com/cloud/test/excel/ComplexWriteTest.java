...
import com.cloud.test.excel.entity.WriteCellDemoData;
...
public class ComplexWriteTest {
    ...
    public static void main(String[] args) {
        String fileName = "/Users/cloud/study/study_project/testFile/write2.xlsx";
     ...
     * @since 3.0.0-beta1
     */
    public void writeCellDataWrite(String fileName) {
